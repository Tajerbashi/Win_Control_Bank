        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromCartKey = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ToCartKey = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CartHistories_Blances_BlanceID",
                        column: x => x.BlanceID,
                        principalSchema: "BUS",
                        principalTable: "Blances",
                        principalColumn: "ID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartHistories_BlanceID",
                schema: "BUS",
                table: "CartHistories",
                column: "BlanceID");
