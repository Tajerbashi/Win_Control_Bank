...
{
    public abstract class RoleRepository : GenericRepository<Role, RoleDTO, RoleView>, IRoleRepository
    {
        protected RoleRepository(UnitOfWork<ContextDbApplication> unitOfWork) : base(unitOfWork)
        {
        }
